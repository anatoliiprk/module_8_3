...
class Car:
    ...
    def __is_valid_vin(self, vin_number):
        if not isinstance(vin_number, int):
            raise IncorrectVinNumber('Некорректный тип vin нормер')
        elif vin_number not in range(999999, 10000000):
...
try:
    ...
    print(exc.message)
else:print(f'{first.model} успешно создан')
